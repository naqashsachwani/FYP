        ...
        <div className='relative flex-1 rounded-3xl overflow-hidden group min-h-[360px] xl:min-h-[420px] shadow-lg'>
          ...
          <div className='relative z-20 p-6 sm:p-12 lg:p-16 flex items-start h-full'>
            ...
            <div className='max-w-lg'>
              ...
              {/* Main Heading - White text with shadow for better readability */}
              ...
              <div className='mt-8 lg:mt-10'>
                <button className='inline-flex items-center justify-center bg-white text-slate-900 text-base font-bold py-4 px-10 rounded-xl shadow-2xl hover:bg-slate-100 hover:shadow-2xl transition-all duration-200 transform hover:-translate-y-1 active:translate-y-0 hover:scale-105'>
                  SHOP NOW
          ...
          <div className='relative flex-1 rounded-3xl overflow-hidden group min-h-[180px] sm:min-h-[200px] shadow-lg'>
            ...
            <div className='relative z-20 p-6 lg:p-8 flex items-center justify-between h-full'>
              <div className='text-white'>
                ...
                <p className='mt-3 text-white/90 font-semibold inline-flex items-center gap-2 group-hover:text-white transition-colors'>
                  View more
