...
const Footer = () => {
  // Enhanced SVG ICONS with consistent styling
  const FacebookIcon = () => (
  ...
  return (
    <footer className="bg-gradient-to-b from-slate-50 to-white border-t border-slate-200 mt-20">
      {/* Gradient Top Border */}
      <div className="h-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-orange-400 w-full"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-12">
            ...
            <div className="flex-1 max-w-md">
              <Link 
                href="/" 
                className="inline-flex items-baseline text-3xl lg:text-4xl font-bold text-slate-800 hover:scale-105 transition-transform duration-200"
              >
              ...
              <div className="mt-6 p-4 bg-white rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button className="px-4 py-2 bg-green-500 text-white text-sm font-semibold rounded-lg hover:bg-green-600 transition-colors duration-200">
                    Join
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 mt-6">
                {socialIcons.map((item, i) => (
                  <Link
                    ...
                    className="group flex items-center justify-center w-10 h-10 bg-white rounded-xl shadow-sm hover:shadow-lg hover:scale-110 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-green-500 transform transition-all duration-300 border border-slate-200"
                  >
                    <item.icon />
                  </Link>
                ))}
                  ...
                  <ul className="space-y-3">
                    {section.links.map((link, i) => (
                      <li key={i}>
                        ...
                        >
                          {link.icon && (
                            <link.icon size={16} className="text-green-500 opacity-70 flex-shrink-0" />
                          )}
        ...
        {/* Bottom Bar */}
        <div className="border-t border-slate-300/50 py-6 lg:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-600">
              <Link href="/privacy" className="hover:text-slate-800 transition-colors hover:underline">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-slate-800 transition-colors hover:underline">
                Terms of Service
              </Link>
              <Link href="/cookies" className="hover:text-slate-800 transition-colors hover:underline">
                Cookies
              </Link>
            </div>
          </div>
